...
(defcustom matlab-fill-fudge-hard-maximum 140
...
(defcustom matlab-handle-graphics-list '("uicontrol"
                                         "uimenu" "uitoolbar"
...
(defcustom matlab-peter-list '("peter" "abs" "acos" "acosh" "acot" "acoth" "acsc" "acsch" "align" "all" "angle"
                               "any" "area" "argnames" "asec" "asech" "asin" "asinh" "assignin"
                               "atan" "atan2" "atanh" "autumn" "bar" "bar3" "bar3h" "barh" "base2dec" "bin2dec"
                               "blanks" "bone" "box" "brighten" "capture" "cart2pol"
                               "cart2sph" "cat" "caxis" "cd" "cdedit" "cdf2rdf" "ceil" "cell"
                               "cell2struct" "celldisp" "cellplot" "char" "chi2cdf" "chi2inv"
                               "chi2pdf" "chi2rnd" "chol" "clabel" "cla" "class" "clc" "clear"
                               "clf" "clock" "colorcube" "colordef" "colormap" "colspace" "close"
                               "colperm" "comet" "comet3" "compass" "compose" "cond" "condeig"
                               "condest" "conj" "contour" "contourf" "contour3" "contourslice"
                               "conv" "cool" "copper" "cos" "cosh" "cot" "coth" "cplxpair" "csc"
                               "csch" "cumsum" "cumtrapz" "cylinder" "dblquad" "deal" "deblank"
                               "dec2base" "dec2bin" "dec2hex" "deconv" "delaunay" "del2" "demo"
                               "det" "diag" "diary" "diff" "digits" "dir" "disp" "display"
                               "dlinmod" "dmperm" "dos" "double" "drawnow" "dsolve" "echo"
                               "edit" "eig" "eigs" "end" "error" "errortrap" "erf" "erfc"
                               "erfcx" "erfinv" "errorbar" "etreeplot" "eval" "evalin" "exist"
                               "exit" "exp" "expand" "expint" "expm" "expm1" "expm2" "expm3" "eye"
                               "ezcontour" "ezcontourf" "ezgraph3" "ezmesh" "ezmeshc" "ezplot"
                               "ezplot3" "ezpolar" "ezsurf" "ezsurfc" "factor" "feather" "feedback"
                               "feval" "fft" "fft2" "fftn" "fftshift" "fieldnames" "fill3"
                               "find" "findobj" "findstr" "findsym" "finverse" "fix" "flag" "fliplr"
                               "flipud" "flipdim" "floor" "flops" "flow" "fmin" "fminbnd" "fmins"
                               "fminunc" "fminsearch" "fnder" "fnint" "fnval" "fnplt" "fopen"
                               "format" "fourier" "fplot" "fprintf" "fread" "fsolve" "full"
                               "funm" "funtool" "fzero" "gamma" "gammainc" "gammaln" "gca"
                               "gcbo" "gcf" "gco" "geomean" "getfield" "getframe" "ginput"
                               "gplot" "gradient" "gray" "grid" "griddata" "gtext"
                               "guide" "harmmean" "help" "helpwin" "helpdesk" "hex2dec" "hex2num"
                               "hidden" "hilb" "hist" "histc" "histfit" "hold" "horner" "hot"
                               "hsv" "ifft" "ifft2" "ifftn" "ifftshift" "ifourier" "ilaplace"
                               "imag" "imagesc" "imfinfo" "imread" "imwrite" "imwrite" "imresize"
                               "ind2sub" "info" "inline" "inmem" "input" "inputname" "int"
                               "int2str" "interp1" "interp2" "interp3" "interpn" "interpft"
                               "intro" "inv" "invhilb" "ipermute" "isa" "ischar" "isequal"
                               "isempty" "isfinite" "isfield" "isglobal" "ishandle" "ishold"
                               "isieee" "isinf" "isletter" "islogical" "ismember" "isnan"
                               "isnumeric" "isobject" "isprime" "isreal" "isspace" "issparse"
                               "isstruct" "isstudent" "iztrans" "jacobian" "jet" "jordan"
                               "keyboard" "kron" "laplace" "lasterr" "lastwarn" "leastsq"
                               "legend" "lighting" "lines" "linmod" "linmod2" "linspace"
                               "ln" "load" "log" "log10" "log2" "loglog" "logm" "logspace"
                               "lookfor" "lower" "lsqnonlin" "lu" "mad" "magic" "maple" "mat2str"
                               "material" "max" "mbuild" "mcc" "mean" "median" "menuedit" "mesh"
                               "meshz" "meshgrid" "mex" "mfunlis" "mhelp" "min" "mkdir"
                               "mkpp" "mod" "more" "movie" "moviein" "mtaylor" "ndims"
                               "nargchk" "nargin" "nargout" "ndgrid" "newplot" "nextpow2"
                               "nnz" "nonzeros" "norm" "normcdf" "normest" "norminv" "normpdf"
                               "normrnd" "notebook" "null" "num2str" "numden" "nzmax" "ode1"
                               "ode15s" "ode23t" "ode23tb" "ode45" "odefile" "odeget"
                               "odephas2" "odephas3" "odeplot" "odeprint" "odeset" "ones"
                               "optimset" "orient" "orth" "pack" "pagedlg" "path" "fclose"
                               "pathtool" "pause" "pcode" "pcolor" "peaks" "permute"
                               "pie" "pie3" "pink" "pinv" "plot" "plot3" "plotmatrix"
                               "plotyy" "poissinv" "poissrnd" "pol2cart" "polar" "poly"
                               "poly2str" "poly2sym" "polyder" "polyfit" "polyval" "polyvalm"
                               "pow2" "ppval" "pretty" "print" "printsys" "prism" "procread"
                               "profile" "propedit" "pwd" "quad" "quad8" "quit" "quiver"
                               "quiver3" "rand" "randn" "randperm" "range" "rank" "rats"
                               "rcond" "real" "reallog" "realpow" "realsqrt" "realmax"
                               "realmin" "rectangle" "rem" "repmat" "reshape" "residue"
                               "ribbon" "rmfield" "roots" "rose" "rot90" "rotate"
                               "rotate3d" "round" "rref" "rsf2csf" "rsums" "save" "scatter"
                               "scatter3" "sec" "sech" "semilogx" "semilogy" "series"
                               "setfield" "setstr" "sign" "signum" "simple"
                               "simplify" "sin" "sinh" "size" "slice" "name"
                               "solve" "spalloc" "sparse" "spconvert" "spdiags" "spfun"
                               "sph2cart" "sphere" "spinmap" "spline" "spones" "sprandsym"
                               "sprank" "spring" "sprintf" "spy" "sqrt" "sqrtm" "squeeze"
                               "sscanf" "stairs" "std" "stem" "step" "str2double" "str2mat"
                               "str2num" "strcat" "strcmp" "strjust" "strmatch" "strncmp"
                               "strrep" "strtok" "struct" "struct2cell" "strvcat" "sub2ind"
                               "subexpr" "subplot" "subs" "subspace" "sum" "summer"
                               "superiorto" "surf" "surfc" "surfl" "surfnorm"
                               "svd" "svds" "sym2poly" "symmmd" "symrcm" "syms"
                               "tan" "tanh" "taylortool" "tf" "title" "file"
                               "trapz" "treelayout" "treeplot" "tril" "trim" "trimesh"
                               "trisurf" "triu" "type" "uint8" "uint16"
                               "unmkpp" "unwrap" "upper" "var" "varargin"
                               "varargout" "vectorize" "ver" "view" "voronoi" "vpa"
                               "warning" "what" "whatsnew" "which"  "white"
                               "whitebg" "who" "whos" "winter" "workspace"
                               "xlabel" "yesinput" "ylabel" "zeros"
                               "zlabel" "zoom" "ztrans" "imshow" "imhist"
                               "figure" "axes" "axis" "line"
                               "surface" "patch" "text" "light"
                               "image" "set" "get"
                               )
  "List of handle peter's matlab key word used in highlighting.
Customizing this variable is only useful if `regexp-opt' is available."
  :group 'matlab
  :type '(repeat (string :tag "MY Keyword: ")))
...
\\|\\(par\\)?for\\|spmd\\|global\\|if\\|otherwise\\|return\\|switch\\|try\\|while\\|tic\\|toc\\)\\>")
   ...
   ;;   )
   '(matlab-find-block-comments
     (0 font-lock-comment-face ) ; commented out
     (1 font-lock-comment-face prepend) ; commented out
     (2 'underline prepend)
     (3 'underline prepend)             ;the comment parts
     )
...
\\(toggle\\|push\\)tool\\|toolbar\\)\\)\\>")
   ...
   (list
    (if (fboundp 'regexp-opt)
        (concat "\\<\\(" (regexp-opt matlab-peter-list) "\\)\\>"))
